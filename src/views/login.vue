<template>
    <div id="login">
        ...
        <div class="input_user">
            ...
            <!-- <button :class="{disable : !hasVal}" @click="goLogin">登录</button> -->
        ...
        methods:{
            goLogin:function(){
                if(this.hasVal){
                    ...
                    var inform = 'username=' + this.username + '&password=' + this.password;
                    this.$axios.get('http://leeyiqing.site/login.php?' + inform)
                    .then((e) => {
                        console.log(e);
                        console.log(e.data);
                        if(e.data == 'error'){
