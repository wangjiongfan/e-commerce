<?php
	...
	$sql = "SELECT product.Id,product.name,product.price,product.img,productdetail.detailKey,productdetail.detailVal FROM `productdetail` inner join `product` on productdetail.pid=product.Id WHERE pid=".$pid;
