<?php
	...
	$sql = "SELECT userorder.Id,userorder.pid,userorder.uid,product.name,product.price,product.img,userorder.productDetail,userorder.count FROM `userorder` inner join `product` on userorder.pid=product.Id WHERE uid=".$uid;
