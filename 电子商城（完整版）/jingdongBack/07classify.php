<?php
	...
	$sql = "SELECT product.Id,product.name,product.price,product.img,product.count,classify.classification FROM `product` inner join `classify` on product.classify=classify.Id WHERE classify=".$cid;
